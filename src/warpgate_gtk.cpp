...
// {
//   const char* vshader_bytes = "#version 330\n\nlayout(location = 0) in vec4 position;\nuniform mat4 mvp;\n\nvoid main() {\n  gl_Position = mvp * position;\n}";
//   if(!vshader_bytes)
//   {
...
//     return;
//   }
//   //gsize vshader_size {strlen(vshader_bytes)};
//   auto vertex = create_shader(GL_VERTEX_SHADER, vshader_bytes);
...
//     return;
//   }
//   auto fragment = create_shader(GL_FRAGMENT_SHADER, fshader_bytes);
