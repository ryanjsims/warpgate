...
layout (location = 2) in vec3 inTexcoord2;
layout (location = 3) in vec3 inTexcoord3;
layout (location = 4) in vec3 inTexcoord4;
layout (location = 5) in vec2 inTexcoord5;
layout (location = 6) in vec2 inTexcoord6;
