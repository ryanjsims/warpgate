...
layout (location = 4) in vec4 inTexcoord7;
layout (location = 5) in vec4 inTexcoord8;
layout (location = 6) in vec4 inTexcoord9;
layout (location = 7) in float inTexcoord10;
...
layout (location = 10) out float outTexcoord10;
